...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'smartcar_model_test=auto_control.smartcar_model_test:main',
            # register the training script so it can be run after pip/colcon install
            'smartcar_train=auto_control.smartcar_train:main',
            'train_continue=auto_control.train_continue:main'
        ],
    },
)
